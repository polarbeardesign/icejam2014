...
//$sql_time_slots .= "WHERE  start_time < \"2013-11-15\" ";
...
<p>The official record of all time slot purchases and the winning time slot will be maintained by the Madison Valley Medical Center Foundation. Winnings of $6,000 or more are required to be reported to the Internal Revenue Service and are subject to 28% withholding.  Winners will be required to provide their name, address, and Social Security number in order to collect raffle proceeds.</p>
